...
start /WAIT "test once to check instalation work" powershell -command C:\'Program Files'\InfluxData\telegraf\telegraf.exe --config 'C:\Program Files\InfluxData\telegraf\telegraf.conf' --test; pause
